 ...
 */
final class Version20200403123407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rent ADD person_nbr INT NOT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rent DROP person_nbr, CHANGE user_id user_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL');
